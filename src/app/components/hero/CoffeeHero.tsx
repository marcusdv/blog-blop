import styles from "./CoffeeHero.module.css";

/**
 * A xícara é a arte de public/images/coffee-tea-hot-beverage-drink-steaming-svgrepo-com.svg
 * (SVG Repo / Twemoji), colada inline para dar pra animar o vapor.
 *
 * O grupo da arte usa a matriz original do arquivo, que inverte o eixo Y — por isso,
 * dentro dela, translateY positivo sobe na tela.
 */
export default function CoffeeHero() {
    return (
        <div className={styles.moldura}>
            <svg className={styles.arte} viewBox="0 0 400 400" role="img" aria-labelledby="coffee-hero-title">
                <title id="coffee-hero-title">Xícara de café fumegante</title>

                {/* sombra dura do círculo */}
                <circle cx="209" cy="211" r="146" fill="var(--main-black)" />
                ...
                <g className={styles.xicara}>
                    <g transform="translate(100 106) scale(4.3)">
                        <g transform="matrix(1.25,0,0,-1.25,0,47.5)">
                            ...
                            <g transform="translate(19,6)">
                                <path d="m 0,0 c -14.958,0 -17,15 -17,19 l 34,0 C 17,17 15.042,0 0,0" fill="#f5f8fa" />
                            </g>

                            {/* borda + asa */}
                            <g transform="translate(32.8818,30.0483)">
                                <path
                            ...
                            {/* vapor */}
                            <g className={`${styles.vapor} ${styles.vapor1}`}>
                            ...
                            <g className={`${styles.vapor} ${styles.vapor2}`}>
